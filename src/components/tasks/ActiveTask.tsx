...
export function ActiveTask({ task, onComplete, onOpenPanel }: ActiveTaskProps) {
  ...
  return (
    <div className="mt-16 w-full max-w-sm flex flex-col gap-3 transition-all duration-300">
      ...
      <div className="flex items-center justify-between gap-4 bg-white/5 p-5 rounded-[24px] border border-white/10 hover:bg-white/10 transition-colors">
        <div 
